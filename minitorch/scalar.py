...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        Returns:
        -------
            d_inputs: A list of derivatives with respect to each leaf variable in `self.parents`
        ...
        backward_fn = h.last_fn._backward

        # Apply the backward function to get the gradients
        grads = backward_fn(h.ctx, d_output)

        # Pair each input variable with its corresponding gradient
